...
int main() {
    ...
    std::ofstream configFile("examples/pipelines/shape_pipeline_config.json");
    configFile << configContent;
    configFile.close();
    
    try {
        // Create pipeline from configuration file
        auto pipeline = ConfigurablePipeline::createFromConfig("examples/pipelines/shape_pipeline_config.json");
